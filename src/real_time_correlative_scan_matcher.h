...
#ifndef REALTIMECORRELATIVESCANMATCHER_H
#define REALTIMECORRELATIVESCANMATCHER_H

#include <Eigen/Dense>
#include <Eigen/Geometry>
#include "point_cloud.h"

#define CHECK_EQ(lhs,rhs) assert(lhs==rhs) 
...
#endif // REALTIMECORRELATIVESCANMATCHER_H
